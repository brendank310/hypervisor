...
protected:
    ...
    virtual bool is_enabled_v8086() const noexcept;

    virtual bool is_enabled_external_interrupt_exiting() const noexcept;
    virtual bool is_enabled_nmi_exiting() const noexcept;
    virtual bool is_enabled_virtual_nmis() const noexcept;
    virtual bool is_enabled_vmx_preemption_timer() const noexcept;
    virtual bool is_enabled_posted_interrupts() const noexcept;

    virtual bool is_enabled_interrupt_window_exiting() const noexcept;
    virtual bool is_enabled_tsc_offsetting() const noexcept;
    virtual bool is_enabled_hlt_exiting() const noexcept;
    virtual bool is_enabled_invlpg_exiting() const noexcept;
    virtual bool is_enabled_mwait_exiting() const noexcept;
    virtual bool is_enabled_rdpmc_exiting() const noexcept;
    virtual bool is_enabled_rdtsc_exiting() const noexcept;
    virtual bool is_enabled_cr3_load_exiting() const noexcept;
    virtual bool is_enabled_cr3_store_exiting() const noexcept;
    virtual bool is_enabled_cr8_load_exiting() const noexcept;
    virtual bool is_enabled_cr8_store_exiting() const noexcept;
    virtual bool is_enabled_tpr_shadow() const noexcept;
    virtual bool is_enabled_nmi_window_exiting() const noexcept;
    virtual bool is_enabled_mov_dr_exiting() const noexcept;
    virtual bool is_enabled_unconditional_io_exiting() const noexcept;
    virtual bool is_enabled_io_bitmaps() const noexcept;
    virtual bool is_enabled_monitor_trap_flag() const noexcept;
    virtual bool is_enabled_msr_bitmaps() const noexcept;
    virtual bool is_enabled_monitor_exiting() const noexcept;
    virtual bool is_enabled_pause_exiting() const noexcept;
    virtual bool is_enabled_secondary_controls() const noexcept;

    virtual bool is_enabled_virtualized_apic() const noexcept;
    virtual bool is_enabled_ept() const noexcept;
    virtual bool is_enabled_descriptor_table_exiting() const noexcept;
    virtual bool is_enabled_rdtscp() const noexcept;
    virtual bool is_enabled_x2apic_mode() const noexcept;
    virtual bool is_enabled_vpid() const noexcept;
    virtual bool is_enabled_wbinvd_exiting() const noexcept;
    virtual bool is_enabled_unrestricted_guests() const noexcept;
    virtual bool is_enabled_apic_register_virtualization() const noexcept;
    virtual bool is_enabled_virtual_interrupt_delivery() const noexcept;
    virtual bool is_enabled_pause_loop_exiting() const noexcept;
    virtual bool is_enabled_rdrand_exiting() const noexcept;
    virtual bool is_enabled_invpcid() const noexcept;
    virtual bool is_enabled_vm_functions() const noexcept;
    virtual bool is_enabled_vmcs_shadowing() const noexcept;
    virtual bool is_enabled_rdseed_exiting() const noexcept;
    virtual bool is_enabled_ept_violation_ve() const noexcept;
    virtual bool is_enabled_xsave_xrestore() const noexcept;

    virtual bool is_enabled_save_debug_controls_on_exit() const noexcept;
    virtual bool is_enabled_host_address_space_size() const noexcept;
    virtual bool is_enabled_load_ia32_perf_global_ctrl_on_exit() const noexcept;
    virtual bool is_enabled_ack_interrupt_on_exit() const noexcept;
    virtual bool is_enabled_save_ia32_pat_on_exit() const noexcept;
    virtual bool is_enabled_load_ia32_pat_on_exit() const noexcept;
    virtual bool is_enabled_save_ia32_efer_on_exit() const noexcept;
    virtual bool is_enabled_load_ia32_efer_on_exit() const noexcept;
    virtual bool is_enabled_save_vmx_preemption_timer_on_exit() const noexcept;

    virtual bool is_enabled_load_debug_controls_on_entry() const noexcept;
    virtual bool is_enabled_ia_32e_mode_guest() const noexcept;
    virtual bool is_enabled_entry_to_smm() const noexcept;
    virtual bool is_enabled_deactivate_dual_monitor_treatment() const noexcept;
    virtual bool is_enabled_load_ia32_perf_global_ctrl_on_entry() const noexcept;
    virtual bool is_enabled_load_ia32_pat_on_entry() const noexcept;
    virtual bool is_enabled_load_ia32_efer_on_entry() const noexcept;

    virtual bool is_supported_external_interrupt_exiting() const noexcept;
    virtual bool is_supported_nmi_exiting() const noexcept;
    virtual bool is_supported_virtual_nmis() const noexcept;
    virtual bool is_supported_vmx_preemption_timer() const noexcept;
    virtual bool is_supported_posted_interrupts() const noexcept;

    virtual bool is_supported_interrupt_window_exiting() const noexcept;
    virtual bool is_supported_tsc_offsetting() const noexcept;
    virtual bool is_supported_hlt_exiting() const noexcept;
    virtual bool is_supported_invlpg_exiting() const noexcept;
    virtual bool is_supported_mwait_exiting() const noexcept;
    virtual bool is_supported_rdpmc_exiting() const noexcept;
    virtual bool is_supported_rdtsc_exiting() const noexcept;
    virtual bool is_supported_cr3_load_exiting() const noexcept;
    virtual bool is_supported_cr3_store_exiting() const noexcept;
    virtual bool is_supported_cr8_load_exiting() const noexcept;
    virtual bool is_supported_cr8_store_exiting() const noexcept;
    virtual bool is_supported_tpr_shadow() const noexcept;
    virtual bool is_supported_nmi_window_exiting() const noexcept;
    virtual bool is_supported_mov_dr_exiting() const noexcept;
    virtual bool is_supported_unconditional_io_exiting() const noexcept;
    virtual bool is_supported_io_bitmaps() const noexcept;
    virtual bool is_supported_monitor_trap_flag() const noexcept;
    virtual bool is_supported_msr_bitmaps() const noexcept;
    virtual bool is_supported_monitor_exiting() const noexcept;
    virtual bool is_supported_pause_exiting() const noexcept;
    virtual bool is_supported_secondary_controls() const noexcept;

    virtual bool is_supported_virtualized_apic() const noexcept;
    virtual bool is_supported_ept() const noexcept;
    virtual bool is_supported_descriptor_table_exiting() const noexcept;
    virtual bool is_supported_rdtscp() const noexcept;
    virtual bool is_supported_x2apic_mode() const noexcept;
    virtual bool is_supported_vpid() const noexcept;
    virtual bool is_supported_wbinvd_exiting() const noexcept;
    virtual bool is_supported_unrestricted_guests() const noexcept;
    virtual bool is_supported_apic_register_virtualization() const noexcept;
    virtual bool is_supported_virtual_interrupt_delivery() const noexcept;
    virtual bool is_supported_pause_loop_exiting() const noexcept;
    virtual bool is_supported_rdrand_exiting() const noexcept;
    virtual bool is_supported_invpcid() const noexcept;
    virtual bool is_supported_vm_functions() const noexcept;
    virtual bool is_supported_vmcs_shadowing() const noexcept;
    virtual bool is_supported_rdseed_exiting() const noexcept;
    virtual bool is_supported_ept_violation_ve() const noexcept;
    virtual bool is_supported_xsave_xrestore() const noexcept;

    virtual bool is_supported_save_debug_controls_on_exit() const noexcept;
    virtual bool is_supported_host_address_space_size() const noexcept;
    virtual bool is_supported_load_ia32_perf_global_ctrl_on_exit() const noexcept;
    virtual bool is_supported_ack_interrupt_on_exit() const noexcept;
    virtual bool is_supported_save_ia32_pat_on_exit() const noexcept;
    virtual bool is_supported_load_ia32_pat_on_exit() const noexcept;
    virtual bool is_supported_save_ia32_efer_on_exit() const noexcept;
    virtual bool is_supported_load_ia32_efer_on_exit() const noexcept;
    virtual bool is_supported_save_vmx_preemption_timer_on_exit() const noexcept;

    virtual bool is_supported_load_debug_controls_on_entry() const noexcept;
    virtual bool is_supported_ia_32e_mode_guest() const noexcept;
    virtual bool is_supported_entry_to_smm() const noexcept;
    virtual bool is_supported_deactivate_dual_monitor_treatment() const noexcept;
    virtual bool is_supported_load_ia32_perf_global_ctrl_on_entry() const noexcept;
    virtual bool is_supported_load_ia32_pat_on_entry() const noexcept;
    virtual bool is_supported_load_ia32_efer_on_entry() const noexcept;

    virtual bool is_supported_eptp_switching() const noexcept;
